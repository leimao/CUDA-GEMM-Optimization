...
#pragma unroll
    ...
    //             &C[C_row_idx * ldc + C_col_vector_idx])};
    //         // Vectorized read from C_thread_results.
    //         int4 const
    //         C_thread_results_row_vector_vals{*reinterpret_cast<int4 const*>(
    //             &C_thread_results[thread_tile_row_idx]
    //                              [thread_tile_col_vector_idx *
    //                              NUM_VECTOR_UNITS])};
    ...
    //         {
    //             *reinterpret_cast<T*>(&C_row_vector_vals) =
    //                 alpha * *reinterpret_cast<T
    //                 const*>(&C_thread_results_row_vector_vals) + beta *
    //                 *reinterpret_cast<T const*>(&C_row_vector_vals);
    //         }
    //         // Vectorized write to C.
    //         *reinterpret_cast<int4*>(&C[C_row_idx * ldc + C_col_vector_idx])
    //         =
    //             C_row_vector_vals;
    //     }
    // }
